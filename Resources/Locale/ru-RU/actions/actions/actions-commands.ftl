...
upgradeaction-command-help = Использование: upgradeaction <entityUid> [level]
upgradeaction-command-need-one-argument = Для upgradeaction требуется минимум один аргумент - UID сущности. Второй необязательный аргумент - целевой уровень.
upgradeaction-command-max-two-arguments = upgradeaction принимает максимум два аргумента: UID сущности и (опционально) уровень для установки.
...
upgradeaction-command-entity-is-not-action = У этого существа нет компонента повышения уровня действия, поэтому это действие не может быть выполнено.
