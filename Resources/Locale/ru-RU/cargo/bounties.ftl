...
bounty-item-ore-silver = Серебренная руда
...
bounty-item-plates = Чешуйки Голиафа
...
bounty-description-ring = Сегодня у семьи Гельт ЗНАМЕНАТЕЛЬНОЕ событие - свадьба! Вот только мистер Гельт умудрился потерять кольца. Пришлите, пожалуйста, новую пару колец! 
