...
chat-manager-sender-announcement-wrap-message =
    %ERASE_NEWLINE%[font size=14][bold]Объявление { $sender }:[/font][font size=12]
    { $message }[/bold][/font]
...
chat-manager-entity-whisper-wrap-message = %ERASE_NEWLINE%[font size=11][italic][BubbleHeader][Name]{ $entityName }[/Name][/BubbleHeader] шепчет,"[BubbleContent]{ $message }[/BubbleContent]"[/italic][/font]
chat-manager-entity-whisper-unknown-wrap-message = %ERASE_NEWLINE%[font size=11][italic][BubbleHeader]Кто-то[/BubbleHeader] шепчет, "[BubbleContent]{ $message }[/BubbleContent]"[/italic][/font]
chat-manager-entity-me-wrap-message = %ERASE_NEWLINE%[italic]{ CAPITALIZE($entityName) } { $message }[/italic]
