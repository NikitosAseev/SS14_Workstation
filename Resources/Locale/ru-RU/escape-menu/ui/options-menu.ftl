...
ui-options-ambient-occlusion = Показывать Ambient Occlusion (затенение)
...
ui-options-function-swap-hands-reverse = Переключить руки (обратное направление)
...
ui-options-function-text-tab-complete = Автодополнение по Tab
...
ui-options-admin-player-tab-symbol-setting = Символы антагов в колонке персонажей
ui-options-admin-player-tab-symbol-setting-off = убрать символ антага
ui-options-admin-player-tab-symbol-setting-basic = базовые символы ангага
ui-options-admin-player-tab-symbol-setting-specific = Конкретный символ антага
...
ui-options-admin-player-tab-role-setting-roletypesubtype = Тип роли и подтип
...
ui-options-admin-player-tab-color-setting-character = Цветные имена антагов
ui-options-admin-player-tab-color-setting-roletype = Цветные типы ролей
ui-options-admin-player-tab-color-setting-both = Цветные имена и типы ролей
ui-options-admin-overlay-title = Админ оверлей
ui-options-admin-overlay-antag-format = Стиль метки антага
ui-options-admin-overlay-antag-format-binary = Статус антага
ui-options-admin-overlay-antag-format-roletype = Тип роли
ui-options-admin-overlay-antag-format-subtype = Подтип
ui-options-admin-overlay-antag-symbol = Стиль символа антагов
ui-options-admin-overlay-antag-symbol-off = Без символов антагов
ui-options-admin-overlay-antag-symbol-basic = Показывать стандартные символы антагов
ui-options-admin-overlay-antag-symbol-specific = Показывать специфические символы антагов
ui-options-admin-enable-overlay-playtime = Показывать игровое время
ui-options-admin-enable-overlay-starting-job = Показывать начальную должность
ui-options-admin-overlay-merge-distance = Дистанция объединения оверлеев
ui-options-admin-overlay-ghost-fade-distance = Дистанция исчезновения оверлея призрака от курсора
