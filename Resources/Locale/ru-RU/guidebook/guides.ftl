...
guide-entry-powerstorage = Хранилища энергии
guide-entry-ramping = Нарастающий темп
guide-entry-voltagenetworks = Вольтажность
...
guide-entry-singularityengine = Генератор гравитационной сингулярности
...
guide-entry-savory-recipes = Пряные блюда
guide-entry-bread-recipes = Хлеб
guide-entry-breakfast-recipes = Перекус
...
guide-entry-soup-recipes = Супы и тушеные блюда
guide-entry-pie-recipes = Пироги и пирожные
guide-entry-barsandcookies-recipes = Батончики и печенье
guide-entry-cake-recipes = Торты
guide-entry-salad-recipes = Салаты
guide-entry-medicinal-recipes = Медецина
