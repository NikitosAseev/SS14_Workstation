ent-CratePlants = ящик с растениями
    .desc = Набор комнатных растений в горшках, чтобы оживить вашу станцию!
...
ent-CrateFunLizardPlushieBulk = оптовый ящик плюшевых рептилий
    .desc = Куча мягких плюшевых рептилий. Разложите их повсюду, а потом подумайте, как вы объясните эту покупку NT.
ent-CrateFunSharkPlushieBulk = оптовый ящик плюшевых акул
...
ent-CrateFunScurret = влажный слизнекот
    .desc = Чтоп сто?
