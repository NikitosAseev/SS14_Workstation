...
ent-CrateSecurityNonlethal = ящик нелетального снаряжения
    .desc = Содержит смесь различной нелетальной аммуниции, а именно станнеры, дубинки-шокеры и вспышки. Чтобы открыть, необходим уровень доступа "Служба безопасности".
