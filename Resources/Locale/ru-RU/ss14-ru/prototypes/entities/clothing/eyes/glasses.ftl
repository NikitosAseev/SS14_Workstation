...
ent-ClothingEyesGlassesSecurity = очки службы безопасности
...
ent-ClothingEyesGlassesNoir = очки в стиле нуар
    .desc = Пара очков, симулирующих восприятие мира до изобретения цветного зрения.
