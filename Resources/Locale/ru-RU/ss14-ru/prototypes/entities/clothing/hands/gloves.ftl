...
ent-ClothingHandsKnuckleDusters = кастеты
    .desc = Холодные пласталевые кастеты. Значительно увеличивают силу удара.
ent-ClothingHandsKnuckleDustersBrass = латунные кастеты
    .desc = Классические латунные кастеты старинного образца. Бьют так же жёстко, как и раньше.
ent-ClothingHandsKnuckleDustersQM = золотые кастеты квартирмейстера
    .desc = Кастеты из 24-каратного золота с пласталевым покрытием и логотипом NanoTrasen. Истинный символ власти квартирмейстера.
ent-ClothingHandsKnuckleDustersSyndicate = кастеты Синдиката
    .desc = Пластитановые кастеты с кроваво-красной буквой S. Настоящий мужик сможет забить кого угодно насмерть этими штуками.
ent-ClothingHandsKnuckleDustersStun = шоковые кастеты
    .desc = Гибрид кастетов и электрошокера. Идеальны для усмирения буйных утилизаторов.
ent-ClothingHandsKnuckleBoneCrushers = костедробители
    .desc = Благословлены богами для сокрушения всех непокорных.