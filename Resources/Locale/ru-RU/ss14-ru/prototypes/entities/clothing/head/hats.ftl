...
ent-ClothingHeadHatCanadaBeanie = шапочка
    .desc = Красное, белое и уютное. Оно создает ощущение домашнего уюта, если в вашем доме прохладно и много кофе.
...
ent-ClothingHeadWehcellentCap = шляпа "Вехцелент"
    .desc = Это сетчатая шляпа! Тайдеры носят их всё время! У неё есть вентиляционные отверстия сзади, чтобы обеспечить циркуляцию воздуха и прочее!
...
ent-ClothingHeadHatSolidHeadband = солидная головная повязка
    .desc = Нося её, вы будете чувствовать себя невидимкой! (ДИСКЛЕЙМЕР: НА САМОМ ДЕЛЕ ЭТО НЕ ДЕЛАЕТ ВЛАДЕЛЬЦА НЕВИДИМЫМ)
ent-ClothingHeadPropellerHat = шапка с пропеллером
    .desc = Теперь ты самый лучший мальчик.
