...
ent-ClothingMaskBlushingClown = смущённая маска клоуна
    .desc = Некоторые шаловливые клоуны уверены, что именно так выглядит Хонкоматерь.
ent-ClothingMaskBlushingMime = смущённая маска мима
...
ent-ClothingMaskMimeSecurity = маска мима-охранника
