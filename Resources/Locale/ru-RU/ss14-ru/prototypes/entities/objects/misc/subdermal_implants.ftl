...
ent-FakeMindShieldImplant = поддельный имплант "защита разума"
    .desc = Этот имплантат позволяет имплантатору генерировать фальшивый сигнал, по которому охранные системы NT идентифицируют людей, которых имплантировали защитой разума.
