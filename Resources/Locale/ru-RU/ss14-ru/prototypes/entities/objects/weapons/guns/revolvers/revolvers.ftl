...
ent-WeaponRevolverMateba = Матеба
    .desc = Современный револьвер, используемый элитным, почти мифическим отрядом быстрого реагирования под кодовым именем "ЭС" корпорации Нанотрейзен. Уникальный спусковой механизм и расположение ствола обеспечивают высокую скорострельность при минимальной отдаче. Многие заглядывали в этот ствол - но немногие смогли потом об этом рассказать. Вмещает 6 патронов калибра .45 магнум.
    .suffix = Револьвер
