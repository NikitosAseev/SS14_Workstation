...
ent-CrateRodentCage = хомячья клетка
    .desc = Клетка с хомяком, родственником гамлета!
ent-CrateBaseLockBox = Ящик
    .desc = Надежный ящик с замком. Средства от его продажи будут переданы обратно в отдел. Только помните: Груз всегда берет долю.
ent-CrateLockBoxEngineering = Инженерный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxMedical = Медицинский ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxScience = Научный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = Ящик СБ
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxService = Сервисный ящик
    .desc = { ent-CrateBaseLockBox.desc }
