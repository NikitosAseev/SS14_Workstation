...
ent-BarSignTheLightbulb = Лампочка
    .desc = Кафе, популярное среди ниан и мотыльков. Однажды его закрыли на неделю после того, как бармен использовала нафталин для обработки своей запасной униформы.
...
ent-BarSignWhiskeyEchoes = Виски Эхо
    .desc = Элитный бар для элитных опер... Подождите, это же станция НаноТрейзен. Почему эта вывеска в базе данных?
