...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвящённого 50-летию компании Nanoposters Manufacturing, дочерней компании НаноТрейзен.
...
ent-PosterLegitSafetyMothDelam = Ниан-хранитель - Меры безопасности при расслаивании
    .desc = Этот информационный плакат использует Ниан-хранителя™, чтобы рассказать читателям о необходимости прятаться в шкафах, если произошло расслоение кристалла суперматерии, чтобы избежать галлюцинаций. Эвакуация может быть лучшей стратегией.
ent-PosterLegitSafetyMothEpi = Ниан-хранитель - Эпинефрин
    .desc = Этот информационный плакат использует Ниан-хранителя™, чтобы рассказать читателям о необходимости оказания помощи раненым/потерявшим сознание членам экипажа при помощи экстренных медипенов с эпинефрином. "Один простой приём позволит предотвратить гниение органов!"
ent-PosterLegitSafetyMothHardhat = Ниан-хранитель - Защитные каски
    .desc = Этот информационный плакат использует Ниан-хранителя™, чтобы рассказать читателям о необходимости использования защитных касок в зонах повышенной опасности. "Это как лампа для головы!"
ent-PosterLegitSafetyMothMeth = Ниан-хранитель - Метамфетамин
    .desc = Этот информационный плакат использует Ниан-хранителя™, чтобы рассказать читателям о необходимости получения разрешения от главного врача перед началом приготовления метамфетамина. "Держитесь ближе к требуемой для приготовления температуре и никогда не превышайте её!"... Никогда не перегревайте метамфетамин.
ent-PosterLegitSafetyMothPiping = Ниан-хранитель - Трубопроводы
    .desc = Этот информационный плакат использует Ниан-хранителя™, чтобы рассказать атмосферным техникам о правильном выборе типов трубопроводов. "Трубы, не насосы! Правильное размещение труб предотвратит низкую эффективность!"
ent-PosterLegitVacation = Корпоративные привилегии НаноТрейзен: Отпуск
    .desc = На этом информационном плакате представлена информация о некоторых призах, которые можно получить в рамках программы "Корпоративные привилегии НТ", включая двухнедельный отпуск на двоих на планете-курорте Идиллус.
...
ent-PosterLegitSafetyMothSSD = Ниан-хранитель - Космическое расстройство сна
    .desc = Этот информационный плакат использует Ниан-хранителя™, чтобы рассказать читателям о Космическом Расстройстве Сна (КРС) - состоянии, при котором член экипажа перестаёт реагировать на происходящее. "Бережно относитесь к членам экипажа с КРС! В любой момент они могут проснуться!"
ent-PosterLegitOppenhopper = Опергеймер
    .desc = Плакат давно забытого фильма. В нём рассказывается о группе упорных салаг из сектора "Кузнечик", которые противостоят атакам печально известных Ядерных Оперативников. Слоган гласит: "Атаки оперативников будут продолжаться, пока робастность не повысится".
