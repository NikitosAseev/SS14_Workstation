...
uplink-radio-implanter-name = Радио имплант
uplink-radio-implanter-desc = Имплантирует рацию, позволяющую скрытно общаться без гарнитуры по частоте Синдиката.
# Bundles
...
uplink-saw-advanced-desc = Высокотехнологичный хирургический инструмент, способный с лёгкостью рассекать плоть и кости
# Armor
...
uplink-clothing-outer-vest-web-elite-desc = Элитный синтетический бронежилет. Оснащён подвесной системой и термостойкими волокнами.
...
uplink-fake-mindshield-name = Поддельный имплант "Щит разума"
uplink-fake-mindshield-desc = Переключаемый имплантат, способный имитировать те же передачи, которые испускает настоящий щит разума, когда он включен, обманывая устройства что могут определять иплант защиты разума, заставляя их думать, что у вас он есть (имплантат марки Nanotrasen не предоставляется).
uplink-smuggler-satchel-name = Сумка контрабандиста
uplink-smuggler-satchel-desc = Удобная, подозрительно выглядящая сумка плосковидной формы, этого достаточно чтобы она могла поместиться под плитками пола.
uplink-access-breaker-name = Дизраптор доступов
uplink-access-breaker-desc = Взломанный конфигуратор доступа и хороший друг ЕМАГА. Это устройство способно принудительно открывать шлюзы, а также стирать требования доступа с оборудования станции. Перезаряжается автоматически.
