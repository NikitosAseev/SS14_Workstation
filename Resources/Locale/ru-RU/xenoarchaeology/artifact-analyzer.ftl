...
analysis-console-extract-none = [font="Monospace" size=11][color=orange] Нет разблокированных узлов с доступными очками для извлечения [/color][/font]
analysis-console-extract-sum = [font="Monospace" size=11][color=orange]Общее количество исследований: { $value }[/color][/font]
